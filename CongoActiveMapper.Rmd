...
-There are four major mapping components: 1) image acquisition and pre-processing, 2) training data, 3) machine learning, and 4) segmentation. 
...
Traning site classfiers from the spatial collective in africa access a OpenLayers.T
he classifiers from the spatial collec work on creating tranning and validtion data
...
Settlement Locations (data from HDX) and the buffer sights
